    ...
    "apply" - {
      "must return a sequence of items without dots ranging from 1 to the total number of pages " +
        ...
        "e.g. 1, 2, 3, 4, 5" in {
          ...
          val result1 = Items(MetaData(10, 5, 1), "testHref", Seq.empty)
          val result2 = Items(MetaData(15, 5, 2), "testHref", Seq.empty)
      ...
      "must return a sequence of items with last item dotted ranging from 1 to the total number of pages " +
        ...
        "e.g. 1, 2, 3, 4 ... 10" in {
          ...
          val result1 = Items(MetaData(12, 2, 1), "testHref", Seq.empty)
          val result2 = Items(MetaData(20, 2, 2), "testHref", Seq.empty)
      ...
      "must return a sequence of items with first item dotted ranging from the last page to the previous 2 pages " +
        ...
        "e.g. 1 ... 7, 8, 9, 10" in {
          ...
          val result1 = Items(MetaData(12, 2, 6), "testHref", Seq.empty)
          val result2 = Items(MetaData(20, 2, 9), "testHref", Seq.empty)
      ...
      "must return a sequence of items with first and last item dotted ranging from the first page to the current page minus 1 " +
        ...
        "e.g. 1 ... 4, 5, 6 ... 10" in {
          ...
          val result = Items(MetaData(20, 2, 6), "testHref", Seq.empty)
