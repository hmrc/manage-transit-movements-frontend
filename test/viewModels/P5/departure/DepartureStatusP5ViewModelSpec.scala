        ...
        "and declaration is amendable" in {
          running(app) {
            ...
            val expectedResult = DepartureStatusP5ViewModel(
              ...
              Seq(
                ViewMovementAction(
                  controllers.departureP5.routes.DeclarationAmendmentRejectionMessageController.onPageLoad(None, departureIdP5, messageId).url,
        ...
        "and declaration is not amendable with one FunctionalError" in {
          running(app) {
            ...
            val expectedResult = DepartureStatusP5ViewModel(
              ...
              Seq(
                ViewMovementAction(
                  controllers.departureP5.routes.ReviewDepartureAmendmentErrorsP5Controller.onPageLoad(None, departureIdP5, messageId).url,
