  ...
  "DepartureStatusP5ViewModel" - {
    ...
    "when given Message with head of cancellationDecision" in {
      ...
      val expectedResult = DepartureStatusP5ViewModel(
        ...
        Seq(
          ViewMovementAction(
            controllers.departureP5.routes.DepartureCancelledP5Controller.isDeclarationCancelled(departureIdP5, lrn).url,
    ...
    "when given Message with head of goodsNotReleased" in {
      ...
      val expectedResult = DepartureStatusP5ViewModel(
        ...
        Seq(
          ViewMovementAction(
            controllers.departureP5.routes.GoodsNotReleasedP5Controller.goodsNotReleased(departureIdP5, lrn, "messageId").url,
      ...
      "and head of tail is IE015" - {
        ...
        "and declaration is amendable" in {
          ...
          val expectedResult = DepartureStatusP5ViewModel(
            ...
            Seq(
              ViewMovementAction(
                controllers.departureP5.routes.RejectionMessageP5Controller.onPageLoad(None, departureIdP5, lrn).url,
        ...
        "and declaration is not amendable with errors in range 2 to 10" in {
          ...
          val expectedResult = DepartureStatusP5ViewModel(
            ...
            Seq(
              ViewMovementAction(
                controllers.departureP5.routes.ReviewDepartureErrorsP5Controller.onPageLoad(None, departureIdP5, lrn).url,
        ...
        "and declaration is not amendable and no FunctionalErrors" in {
          ...
          val expectedResult = DepartureStatusP5ViewModel(
            ...
            Seq(
              ViewMovementAction(
                controllers.departureP5.routes.DepartureDeclarationErrorsP5Controller.onPageLoad(departureIdP5, lrn).url,
                "movement.status.P5.action.rejectedByOfficeOfDeparture.viewErrors"
              )
            )
          )
      ...
      "and head of tail is IE014" - {
        ...
        "with errors in range 2 to 10" in {
          ...
          val expectedResult = DepartureStatusP5ViewModel(
            ...
            Seq(
              ViewMovementAction(
                controllers.departureP5.routes.ReviewCancellationErrorsP5Controller.onPageLoad(None, departureIdP5, lrn).url,
                "movement.status.P5.action.rejectedByOfficeOfDeparture.viewErrors"
              )
            )
          )
        ...
        "with no FunctionalErrors" in {
          ...
          val expectedResult = DepartureStatusP5ViewModel(
            ...
            Seq(
              ViewMovementAction(
                controllers.departureP5.routes.CancellationNotificationErrorsP5Controller.onPageLoad(departureIdP5, lrn).url,
                "movement.status.P5.action.rejectedByOfficeOfDeparture.viewErrors"
              )
            )
          )
    ...
    "when given Message with head of goodsUnderControl" - {
      ...
      "when prelodged" in {
        ...
        val expectedResult = DepartureStatusP5ViewModel(
          ...
          Seq(
            ViewMovementAction(
              controllers.departureP5.routes.GoodsUnderControlIndexController.onPageLoad(departureIdP5).url,
    ...
    "when given Message with head of goodsBeingRecovered" in {
      ...
      val expectedResult = DepartureStatusP5ViewModel(
        ...
        Seq(
          ViewMovementAction(
            controllers.departureP5.routes.RecoveryNotificationController.onPageLoad(departureIdP5, "messageId", lrn).url,
