  ...
  "UnloadingRemarkWithoutFunctionalErrorsP5ViewModel" - {
    ...
    "title" - {
      "must return correct message" in {
        viewModel().title mustEqual "Unloading remarks errors"
      }
    }
    ...
    "paragraph1" - {
      "must return correct message" in {
        viewModel().paragraph1 mustEqual s"There are one or more errors with the unloading remarks for this notification."
      }
    }
    ...
    "customsOfficeContent" - {
      ...
      "when customs office found with telephone number and name" - {
        "must return correct message" in {
          ...
          result mustEqual s"Try making the unloading remarks again. Or for more information, contact Customs at $customsOfficeName on ${telephoneNo.get}."
        }
      }
      ...
      "when customs office found with name and no telephone number" - {
        "must return correct message" in {
          ...
          result mustEqual s"Try making the unloading remarks again. Or for more information, contact Customs at $customsOfficeName."
        }
      }
      ...
      "when customs office found with telephone number but empty name" - {
        "must return correct message" in {
          ...
          result mustEqual s"Try making the unloading remarks again. Or for more information, contact Customs office $customsReferenceId on ${telephoneNo.get}."
        }
      }
      ...
      "when customs office found with no telephone number and empty name" - {
        "must return correct message" in {
          ...
          result mustEqual s"Try making the unloading remarks again. Or for more information, contact Customs office $customsReferenceId."
        }
      }
    }
    ...
    "hyperlink" - {
      "must return correct message" in {
        viewModel().hyperlink mustEqual "View arrival notifications"
      }
    }
  }
