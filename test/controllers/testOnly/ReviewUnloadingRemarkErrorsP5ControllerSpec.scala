...
class ReviewUnloadingRemarkErrorsP5ControllerSpec extends SpecBase with AppWithDefaultMockFixtures with ScalaCheckPropertyChecks with Generators {

  private val mockReviewUnloadingRemarkErrorMessageP5ViewModelProvider = mock[ReviewUnloadingRemarkErrorsP5ViewModelProvider]
  ...
  lazy val rejectionMessageController: String = controllers.testOnly.routes.ReviewUnloadingRemarkErrorsP5Controller.onPageLoad(departureIdP5).url
  ...
  "RejectionUnloadingRemarkP5Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val rejectionMessageP5ViewModel = new ReviewUnloadingRemarkErrorsP5ViewModel(sections, mrn, true)
      ...
      val view = injector.instanceOf[ReviewUnloadingRemarkErrorsP5View]
