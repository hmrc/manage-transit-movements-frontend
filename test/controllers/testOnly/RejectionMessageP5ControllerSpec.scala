  ...
  "RejectionMessageP5Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(rejectionMessageP5ViewModel, departureIdP5, paginationViewModel, lrn, isAmendmentJourney = false)(request, messages, frontendAppConfig).toString
    }
    ...
    "must return OK and the correct view for a GET when amendment journey and declaration is amendable" in {
      ...
      contentAsString(result) mustEqual
        view(rejectionMessageP5ViewModel, departureIdP5, paginationViewModel, lrn, isAmendmentJourney = true)(request, messages, frontendAppConfig).toString
    }
