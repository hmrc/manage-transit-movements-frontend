...
class CancellationReasonControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  val formProvider = new CancellationReasonFormProvider()
  val form         = formProvider()

  lazy val cancellationReasonRoute = routes.CancellationReasonController.onPageLoad(lrn).url
  ...
  "CancellationReason Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      templateCaptor.getValue mustEqual "cancellationReason.njk"
