  ...
  "DepartureCancelledP5Controller" - {
    ...
    "must redirect to correct controller" - {
      "when decision is true" in {
        ...
        redirectLocation(result).value mustEqual controllers.departureP5.routes.DepartureCancelledP5Controller.declarationNotCancelled(departureIdP5, lrn).url
      ...
      "when decision is false" in {
        ...
        status(result) mustEqual SEE_OTHER
        redirectLocation(result).value mustEqual controllers.departureP5.routes.DepartureCancelledP5Controller.declarationCancelled(departureIdP5, lrn).url
      }
    }
    ...
    "must return OK and the correct view for a GET" - {
      ...
      "when decision is true" in {
        ...
        val request = FakeRequest(GET, controllers.departureP5.routes.DepartureCancelledP5Controller.declarationCancelled(departureIdP5, lrn).url)
      ...
      "when decision is false" in {
        ...
        val request = FakeRequest(GET, controllers.departureP5.routes.DepartureCancelledP5Controller.declarationNotCancelled(departureIdP5, lrn).url)
