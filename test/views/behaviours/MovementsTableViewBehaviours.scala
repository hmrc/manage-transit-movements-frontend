        ...
        case (row, rowIndex) =>
          s"row ${rowIndex + 1}" - {
            ...
            "display correct time" in {
              ...
              behave like elementWithHiddenText(updated, s"$prefix.table.updated")
            }
            ...
            "display correct reference number" in {
              ...
              behave like elementWithHiddenText(ref, s"$prefix.table.$referenceNumberType")
            }
            ...
            "display correct status" in {
              ...
              behave like elementWithHiddenText(status, s"$prefix.table.status")
            }
            ...
            "display actions" - {
              ...
              "include hidden content" in {
                behave like elementWithHiddenText(actions, s"$prefix.table.action")
              }
