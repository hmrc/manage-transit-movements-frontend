...
class ReviewDepartureErrorsP5ViewSpec extends PaginationViewBehaviours[ListPaginationViewModel] with TableViewBehaviours with Generators {
  ...
  val paginationViewModel: ListPaginationViewModel = ListPaginationViewModel(
    ...
    href = controllers.departureP5.routes.ReviewDepartureErrorsP5Controller.onPageLoad(None, departureId.toString, lrn).url,
  ...
  behave like pageWithPagination(controllers.departureP5.routes.ReviewDepartureErrorsP5Controller.onPageLoad(None, departureId.toString, lrn).url)
