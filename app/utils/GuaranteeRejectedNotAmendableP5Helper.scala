...
class GuaranteeRejectedNotAmendableP5Helper(guaranteeReferences: Seq[GuaranteeReferenceType08])(implicit messages: Messages) extends DeparturesP5MessageHelper {
