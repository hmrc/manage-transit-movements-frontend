...
object ViewDepartureP5 {
  ...
  def apply(movementAndMessage: MovementAndMessage)(implicit frontendAppConfig: FrontendAppConfig, clock: Clock): Option[ViewDepartureP5] =
    DepartureStatusP5ViewModel(movementAndMessage).map {
      departureStatus =>
